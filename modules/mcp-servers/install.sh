...
lists=("$DOTFILES_DIR/.claude/mcp-servers.list")
case "$(uname -s)" in
    Darwin) lists+=("$DOTFILES_DIR/.claude/mcp-servers.darwin.list") ;;
    Linux)  lists+=("$DOTFILES_DIR/.claude/mcp-servers.linux.list") ;;
esac
