...
export function PeerMessage({
  ...
  const header = (
    <View style={{ flexDirection: "row", alignItems: "center", gap: 6 }}>
      <Icon name="MessagesSquare" size={ICON_SIZE} color={PEER_ACCENT} />
      <Text selectable style={{ color: PEER_ACCENT, fontSize: layout.compact ? 12 : 13, fontWeight: "600" }}>
        {senderLabel(data)}
      </Text>
    </View>
  );
  ...
  return (
    <View
      style={{
        ...
        borderWidth: 1,
        borderColor: hexToRgba(PEER_ACCENT, 0.45),
        backgroundColor: hexToRgba(PEER_ACCENT, 0.07),
      }}
    >
      {header}
      <MarkdownText
