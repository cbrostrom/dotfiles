---
name: capabilities
description: Route tasks to the right custom tool. Reads the generated capability map (~/.agents/capabilities.md) covering Paseo plugins, pi extensions, and shared skills. Use when a task touches MCP servers, Paseo plugins, step plans, herdr/orca integrations, or when you wonder "is there a tool for X". Also the safety net for stale inventories.
---
