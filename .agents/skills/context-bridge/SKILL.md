...
Write to: `~/Vaults/Brain/Brains/<slug>/context-bridge.md`
...
1. Read `~/Vaults/Brain/Brains/<slug>/context-bridge.md`
2. Read `~/Vaults/Brain/Brains/<slug>/current.md` + `next.md`
