...
#
# Works on macOS and Linux; replaces the manually placed arm64 binary.
#
# Idempotent: rewrites the wrapper on every run, keeps the venv if valid.
# =============================================================================
...
cat >"$WRAPPER" <<EOF
#!/usr/bin/env bash
# Generated by ~/dotfiles/scripts/install/higgins.sh — do not edit.
export PYTHONPATH="$HIGGINS_SRC\${PYTHONPATH:+:\$PYTHONPATH}"
